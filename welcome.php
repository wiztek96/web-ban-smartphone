...
<title>Giới thiệu IT Plus</title>
</head>
...
<strong>Sản phẩm nổi bật</strong></p> 
  ...
  <div id="right">
   ...
   <?php 
	...
	?>
  <p style="text-align:center; padding: 80px;font-family: Cambria, Hoefler Text, Liberation Serif, Times, Times New Roman, serif;font-weight: inherit;font-size: 36px"><strong><?php echo $query['gt'];?></strong></p>
