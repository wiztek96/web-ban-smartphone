...
<ul>
  ...
  <div id="right">
   ...
   <table bgcolor="#990000" style="margin-top:20px; color:white;">
              ...
              <td width="189" height="41">Nhập tt giới thiệu</td>
               <td width="498"><input name="chu" type="text" id="chu" size="60"  placeholder="Nhập tt giới thiệu "/></td>
		...
		{
			$sql="update gioithieu set gt='".$_POST['chu']."' where id =1";
			mysqli_query($conn,$sql);
			header("location:configgt.php");
		}
		}
	
			?>
			<center><h1>Xem trước giới thiệu</h1></center>
	...
	?>
  <p style="text-align:center; padding: 30px;font-family: Cambria, Hoefler Text, Liberation Serif, Times, Times New Roman, serif;font-weight: inherit;font-size: 36px"><?php echo $query['gt'];?></p>
